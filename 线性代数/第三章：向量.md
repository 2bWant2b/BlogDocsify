...
$$
\beta = x_1 \symbfit{\alpha}_1 + x_2 \symbfit{\alpha}_2  +\cdots x_m \symbfit{\alpha}_m
$$
...
设$\symbfit{E}_1,\symbfit{E}_2 ,\cdots,\symbfit{E}_n$是向量空间的一组基，如果满足：
$$
(\symbfit{E}_i,\symbfit{E}_j) = \begin{cases} 1,i=j \\ 0,i \ne j \end{cases}
$$
则称$\symbfit{E}_1,\symbfit{E}_2 ,\cdots,\symbfit{E}_n$为**规范正交基**。

### 过渡矩阵

$n$维向量空间的两组基$(1)\symbfit{\alpha}_1,\symbfit{\alpha}_2,\cdots \symbfit{\alpha}_n,(2)\symbfit{\beta}_1,\symbfit{\beta}_2,\cdots \symbfit{\beta}_n$若：
$$
\symbfit{\beta}_1 = c_{11} \alpha_1 + c_{21} \alpha_2 + \cdots + c_{n1} \alpha_{n} \\
\symbfit{\beta}_2 = c_{12} \alpha_1 + c_{22} \alpha_2 + \cdots + c_{n2} \alpha_{n} \\
\cdots \cdots\\ 
\symbfit{\beta}_n = c_{1n} \alpha_1 + c_{2n} \alpha_2 + \cdots + c_{nn} \alpha_{n} \\
$$
即
$$
...
\end{pmatrix}
$$
$C$称为由基$\symbfit{\alpha}_1,\symbfit{\alpha}_2,\cdots \symbfit{\alpha}_n$到基$\symbfit{\beta}_1,\symbfit{\beta}_2,\cdots \symbfit{\beta}_n$的**过渡矩阵**

由基$\symbfit{\alpha}_1,\symbfit{\alpha}_2,\cdots \symbfit{\alpha}_n$到基$\symbfit{\beta}_1,\symbfit{\beta}_2,\cdots \symbfit{\beta}_n$的过渡矩阵可写为：
$$
...
如果向量$\gamma$在基$\symbfit{\alpha}_1,\symbfit{\alpha}_2,\cdots \symbfit{\alpha}_n$下的坐标为$x_1,x_2,\cdots,x_n$，向量$\gamma$在基$\symbfit{\beta}_1,\symbfit{\beta}_2,\cdots \symbfit{\beta}_n$下的坐标为$y_1,y_2,\cdots,y_n$，则坐标变换公式为
$$
\begin{pmatrix}
x_1 \\
x_2 \\
...
\symbfit{x} = \symbfit{C}\symbfit{y}
$$
其中$n$阶矩阵$\symbfit{C}$是由基$\symbfit{\alpha}_1,\symbfit{\alpha}_2,\cdots \symbfit{\alpha}_n$到基$\symbfit{\beta}_1,\symbfit{\beta}_2,\cdots \symbfit{\beta}_n$的过渡矩阵
